                  ...
                  <div class="flex items-center gap-1.5 min-w-0 flex-1 h-7">
                    <Show when={!agentsLoading()}>
                      <div
                        ...
                        data-agent={props.controls.agents.current}
                      >
                        <TooltipKeybind
                          placement="top"
                          gutter={4}
                        ...
                        >
                          <Select
                            ...
                            classList={{
                              "text-text-base": props.controls.agents.current !== "plan",
                              "text-[var(--icon-agent-plan-base)]!": props.controls.agents.current === "plan",
                            }}
