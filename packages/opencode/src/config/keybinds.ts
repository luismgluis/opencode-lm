...
const KeybindsSchema = Schema.Struct({
  ...
  automation_list: keybind("none", "List automations"),
  automation_create: keybind("none", "Create a new automation"),
  automation_run: keybind("none", "Run the selected automation"),
  automation_open: keybind("none", "Open the last session of an automation"),
  automation_history: keybind("none", "View run history of an automation"),
  automation_export: keybind("none", "Export the selected automation"),
  automation_export_all: keybind("none", "Export all automations"),
  automation_import: keybind("none", "Import automations from file"),
  automation_clear_history: keybind("none", "Clear automation run history"),
  automation_edit: keybind("none", "Edit the selected automation"),
  automation_delete: keybind("none", "Delete the selected automation"),
